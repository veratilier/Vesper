...
globalThis.wakeSend=async()=>{sent++;return {delivered:1,gone:[]}};
...
const req=(auth=true)=>new Request('https://test/api/wake',{method:'POST',headers:auth?{'test-auth':'yes'}:{},body:JSON.stringify({requestId:'one',message:'Saved reply'})});
